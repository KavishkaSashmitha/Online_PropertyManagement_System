...
<title>OnlineProperty - unsuccess</title>
...
<h1>You are Unsuccessfully Registered to the Property Management System</h1>

<a href="TenantRegister.jsp"><button type="button" class="btn">Register Here</button></a>
